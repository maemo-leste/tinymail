...
#define CAMEL_MIME_FILTER_CRLF_TYPE         (camel_lite_mime_filter_crlf_get_type ())
...
CamelType camel_lite_mime_filter_crlf_get_type (void);

CamelMimeFilter *camel_lite_mime_filter_crlf_new (CamelMimeFilterCRLFDirection direction, CamelMimeFilterCRLFMode mode);
