...
#define CAMEL_TRANSPORT_TYPE     (camel_lite_transport_get_type ())
...
/* public methods */
gboolean camel_lite_transport_send_to (CamelTransport *transport,
				  CamelMimeMessage *message,
				  CamelAddress *from,
...
CamelType camel_lite_transport_get_type (void);
