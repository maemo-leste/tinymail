...
#define CAMEL_TCP_STREAM_RAW_TYPE     (camel_lite_tcp_stream_raw_get_type ())
...
CamelType camel_lite_tcp_stream_raw_get_type (void);

/* public methods */
CamelStream *camel_lite_tcp_stream_raw_new (void);
