...
static void
camel_lite_stream_null_class_init (CamelStreamClass *camel_lite_stream_null_class)
{
	CamelStreamClass *camel_lite_stream_class = (CamelStreamClass *)camel_lite_stream_null_class;
...
CamelType
camel_lite_stream_null_get_type (void)
{
	static CamelType camel_lite_stream_null_type = CAMEL_INVALID_TYPE;

	if (camel_lite_stream_null_type == CAMEL_INVALID_TYPE) {
		camel_lite_stream_null_type = camel_lite_type_register( camel_lite_stream_get_type(),
							      "CamelLiteStreamNull",
							      sizeof( CamelStreamNull ),
							      sizeof( CamelStreamNullClass ),
							      (CamelObjectClassInitFunc) camel_lite_stream_null_class_init,
							      NULL,
							      NULL,
							      NULL );
	}

	return camel_lite_stream_null_type;
}

/**
 * camel_lite_stream_null_new:
 *
 ...
 **/
CamelStream *
camel_lite_stream_null_new(void)
{
	return (CamelStream *)camel_lite_object_new(camel_lite_stream_null_get_type ());
}
