...
#define CAMEL_MH_FOLDER_TYPE     (camel_lite_mh_folder_get_type ())
...
/* public methods */
CamelFolder *camel_lite_mh_folder_new(CamelStore *parent_store, const char *full_name, guint32 flags, CamelException *ex);
