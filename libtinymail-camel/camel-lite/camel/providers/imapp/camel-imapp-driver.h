...
#define CAMEL_IMAPP_DRIVER_TYPE     (camel_lite_imapp_driver_get_type ())
...
CamelType       	camel_lite_imapp_driver_get_type (void);

CamelIMAPPDriver *	camel_lite_imapp_driver_new(CamelIMAPPStream *stream);

void			camel_lite_imapp_driver_set_sasl_factory(CamelIMAPPDriver *id, CamelIMAPPSASLFunc get_sasl, void *sasl_data);
void			camel_lite_imapp_driver_set_login_query(CamelIMAPPDriver *id, CamelIMAPPLoginFunc get_login, void *login_data);

void			camel_lite_imapp_driver_login(CamelIMAPPDriver *id);

void			camel_lite_imapp_driver_select(CamelIMAPPDriver *id, struct _CamelIMAPPFolder *folder);
void			camel_lite_imapp_driver_update(CamelIMAPPDriver *id, struct _CamelIMAPPFolder *folder);
void			camel_lite_imapp_driver_sync(CamelIMAPPDriver *id, gboolean expunge, struct _CamelIMAPPFolder *folder);
...
GPtrArray *		camel_lite_imapp_driver_list(CamelIMAPPDriver *id, const char *name, guint32 flags);

struct _CamelStream *camel_lite_imapp_driver_get(CamelIMAPPDriver *id, struct _CamelIMAPPFolder *folder, const char *uid);
void camel_lite_imapp_driver_append(CamelIMAPPDriver *id, struct _CamelIMAPPFolder *folder, struct _CamelDataWrapper *);
