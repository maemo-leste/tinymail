...
static void camel_lite_offline_journal_class_init (CamelOfflineJournalClass *klass);
static void camel_lite_offline_journal_init (CamelOfflineJournal *journal, CamelOfflineJournalClass *klass);
static void camel_lite_offline_journal_finalize (CamelObject *object);
...
CamelType
camel_lite_offline_journal_get_type (void)
{
	static CamelType type = NULL;

	if (!type) {
		type = camel_lite_type_register (camel_lite_object_get_type (),
					    "CamelLiteOfflineJournal",
					    sizeof (CamelOfflineJournal),
					    sizeof (CamelOfflineJournalClass),
					    (CamelObjectClassInitFunc) camel_lite_offline_journal_class_init,
					    NULL,
					    (CamelObjectInitFunc) camel_lite_offline_journal_init,
					    (CamelObjectFinalizeFunc) camel_lite_offline_journal_finalize);
	}
...
static void
camel_lite_offline_journal_class_init (CamelOfflineJournalClass *klass)
{
	parent_class = camel_lite_type_get_global_classfuncs (CAMEL_OBJECT_TYPE);
}

static void
camel_lite_offline_journal_init (CamelOfflineJournal *journal, CamelOfflineJournalClass *klass)
{
	journal->folder = NULL;
...
static void
camel_lite_offline_journal_finalize (CamelObject *object)
{
...
/**
 * camel_lite_offline_journal_construct:
 ...
 **/
void
camel_lite_offline_journal_construct (CamelOfflineJournal *journal, CamelFolder *folder, const char *filename)
{
	EDListNode *entry;
	FILE *fp;
...
/**
 * camel_lite_offline_journal_set_filename:
 * @journal: a #CamelOfflineJournal object
 ...
 **/
void
camel_lite_offline_journal_set_filename (CamelOfflineJournal *journal, const char *filename)
{
...
/**
 * camel_lite_offline_journal_write:
 * @journal: a #CamelOfflineJournal object
 * @ex: a #CamelException
 *
 ...
 **/
int
camel_lite_offline_journal_write (CamelOfflineJournal *journal, CamelException *ex)
{
	EDListNode *entry;
	FILE *fp;
	int fd;
...
/**
 * camel_lite_offline_journal_replay:
 * @journal: a #CamelOfflineJournal object
 * @ex: a #CamelException
 *
 ...
 **/
int
camel_lite_offline_journal_replay (CamelOfflineJournal *journal, CamelException *ex)
{
