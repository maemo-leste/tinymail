...
#define CAMEL_MIME_FILTER_PGP_TYPE         (camel_lite_mime_filter_canon_get_type ())
...
CamelType camel_lite_mime_filter_pgp_get_type (void);

CamelMimeFilter *camel_lite_mime_filter_pgp_new(void);
